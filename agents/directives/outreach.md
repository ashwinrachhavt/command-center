...
Build a concise draft from the requested recipient, purpose and relevant company/person context. Use only the explicitly selected account and available read tools for correspondence context. Do not claim to have searched Gmail if that capability is not connected and granted.
