"""Add verified Sol, Luna and Jev rates to app-managed default plans."""
...
revision = "0034_routing_rates"
down_revision = "0033_gmail_sessions"
branch_labels = None
depends_on = None
...
MODEL_RATES = [
    ...
    for provider, model, incoming, outgoing in (
        ("openai", "gpt-6-sol", 2_000_000, 10_000_000),
        ("openai", "gpt-6-luna", 100_000, 500_000),
        ("typesafe", "jev-1.13.0", 42_000, 0),
    )
]
